...
export default Vue.extend({
  ...
  methods: {
    ...
    async handleDrag(e) {
      ...
      let tmpDeltaX = axis && axis !== "y" ? mouseClickPosition.mouseX - (e.touches ? e.touches[0].pageX : e.pageX) : 0;
      let tmpDeltaY = axis && axis !== "x" ? mouseClickPosition.mouseY - (e.touches ? e.touches[0].pageY : e.pageY) : 0;
      tmpDeltaX = tmpDeltaX / EditorStore.zoom;
      tmpDeltaY = tmpDeltaY / EditorStore.zoom;
